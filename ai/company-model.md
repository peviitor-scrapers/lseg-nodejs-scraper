...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "LSEG") |
| group        | string   | Parent company group (e.g. "LSEG") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/peviitor-scrapers/lseg-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)